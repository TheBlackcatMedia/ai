---
name: storyboard
description: Map every shot of a reel with precise timing, visual descriptions, and shot-type assignments. Use when the user types /storyboard with a script and art direction.
---

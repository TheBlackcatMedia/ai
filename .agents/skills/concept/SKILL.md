---
name: concept
description: Generate 3 distinct creative concepts from a validated brief, each with its own visual world and narrative angle. Use when the user types /concept after producing a brief.
---

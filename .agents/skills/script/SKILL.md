---
name: script
description: Write dense, punchy short-form video scripts that hold attention from first word to last. Use when the user types /script with a chosen concept.
---

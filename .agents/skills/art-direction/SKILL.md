---
name: art-direction
description: Define the complete visual language of a piece — palette, mood, lighting, composition, references. Use when the user types /art-direction after a concept or script.
---

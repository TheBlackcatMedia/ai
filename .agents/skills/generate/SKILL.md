---
name: generate
description: Generate AI images and videos for a shot deck, choosing the right models, prompts, and settings per shot. Use when the user types /generate with an approved storyboard.
---

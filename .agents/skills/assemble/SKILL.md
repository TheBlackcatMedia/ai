---
name: assemble
description: Assemble a final reel from generated shots, voiceover, and captions into a polished, timeline-synced video. Use when the user types /assemble with completed shots.
---
